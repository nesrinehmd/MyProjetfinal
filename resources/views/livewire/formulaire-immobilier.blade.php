...
<div class="modal" id="modal02">
            <div class="animate">
                ...
                <div>
                    ...
                    <div class="infos-filtres" id="mob-filtres"> <!-- Filtres  -->
                        <div>
                            <label>Crédit bancaire</label> <input type="checkbox">
                        </div>
                        <div>
                            <label>Promesse de vente</label> <input type="checkbox">
                        </div>                  
                        <div>
                            <label>Echange</label> <input type="checkbox">
                        </div>
                        <div>
                            <label>Photos</label> <input type="checkbox">
                        </div>       
                    </div>

                                        
                        <div>
                            <label>Supérficie</label>
